...
--[[o110 = Instance.new("ScreenGui")
o111 = Instance.new("TextBox")
o112 = Instance.new("TextButton")
...
o109.Position = Vector3.new(12.0515394, 40.7946739, -70.0561295)
--[[o110.Name = "MusicGui"
o110.Parent = plr.PlayerGui
o111.Name = "ID"
o111.BackgroundColor3 = Color3.fromRGB(115, 115, 115)
o111.BackgroundTransparency = 0.3
o111.BorderColor3 = Color3.fromRGB(27, 2, 53)
o111.BorderSizePixel = 5
o111.Position = UDim2.new(0, 5,0, 400)
o111.Size = UDim2.new(0, 130, 0, 45)
o111.Font = Enum.Font.ArialBold
o111.PlaceholderColor3 = Color3.fromRGB(54, 84, 106)
o111.Text = "530626400"
o111.TextColor3 = Color3.fromRGB(54, 84, 106)
o111.TextScaled = true
o111.TextSize = 14
o111.Parent = o110
o112.Name = "Play"
o112.Parent = o111
o112.AutoButtonColor = true
o112.BackgroundColor3 = Color3.fromRGB(85, 170, 0)
o112.BorderColor3 = Color3.fromRGB(50, 80, 103)
o112.BorderSizePixel = 5
o112.Position = UDim2.new(0, 135, 0, 0)
o112.Size = UDim2.new(0, 50, 0, 20)
o112.Font = Enum.Font.ArialBold
o112.Text = "Play"
o112.TextColor3 = Color3.fromRGB(54, 84, 106)
o112.TextScaled = true
o112.TextSize = 14
o113.Name = "Stop"
o113.Parent = o111
o113.AutoButtonColor = true
o113.BackgroundColor3 = Color3.fromRGB(170, 0, 0)
o113.BorderColor3 = Color3.fromRGB(50, 80, 103)
o113.BorderSizePixel = 5
o113.Position = UDim2.new(0, 135, 0, 25)
o113.Size = UDim2.new(0, 50, 0, 20)
o113.Font = Enum.Font.ArialBold
o113.Text = "Stop"
o113.TextColor3 = Color3.fromRGB(54, 84, 106)
o113.TextScaled = true
o113.TextSize = 14
o114.Name = "Hide"
o114.Parent = o111
o114.AutoButtonColor = true
o114.BackgroundColor3 = Color3.fromRGB(115, 115, 115)
o114.BorderColor3 = Color3.fromRGB(50, 80, 103)
o114.BorderSizePixel = 5
o114.Position = UDim2.new(0, 185.5, 0, 0)
o114.Size = UDim2.new(0, 20, 0, 45)
o114.Font = Enum.Font.ArialBold
o114.Text = "<"
o114.TextColor3 = Color3.fromRGB(54, 84, 106)
o114.TextScaled = true
o114.TextSize = 14]]
o1.PrimaryPart = o109
...
if string.sub(msg, 1, 8) == "/dronemsg" then
	local dmsg = (string.sub(msg, 10))
	wait(0.2)
	cMsg(dmsg)
elseif string.sub(msg, 1, 10) == "/dronesong" then
	local dsong = (string.sub(msg, 12))
	wait(0.2)
	s = Instance.new("Sound",char)
		...
		s.SoundId = "http://www.roblox.com/asset?id="..dsong
		s:Play()
		cMsg("Song id:"..dsong)
elseif string.sub(msg, 1, 11) == "/dronelight" then
	local lightcol = (string.sub(msg, 13))
	wait(0.2)
	o1:FindFirstChild("Eye").BrickColor = BrickColor.new(lightcol)
		cMsg("Light color changed to:"..lightcol)
elseif string.sub(msg, 1, 10) == "/dronecmds" then
	local lightcol = (string.sub(msg, 12))
	wait(0.2)
cMsg("Commands are: /dronemsg (msg),")
cMsg("/dronesong (id),")
cMsg(" and /dronelight (brick color).")
cMsg("Also, when you use /dronelight,")
cMsg("the brick color should be case sensitive.")
end
end)
...
soisoi.SoundId = "rbxassetid://6110715420"
soisoi.Volume = 0.3
soisoi.Pitch = 2
soisoi.Looped = true
soisoi:Play()
...
for i,v in pairs(o1:FindFirstChild("Smg"):GetChildren()) do
    v.Transparency = 1
end
...
function cMsg(c)
	...
	tl.FontSize = "Size"..fsiz or "Size"..msize or "Size20"
	tl.TextColor3 = tcol
	tl.TextScaled = false
	...
	for i=1,#c do
		if msgidGlob == curMsgId then
			...
			if string.sub(c,i,i) ~= " " then
				...
				o112.ClickDetector.MouseClick:connect()
				local s = Instance.new("Sound",p)
				local musicid = o111.Text
				s.SoundId = "rbxassetid://"..musicid
				s.Volume = 1
				s.Pitch = 1
				s:Play()
				o113.ClickDetector.MouseClick:connect()
				s:Stop()
